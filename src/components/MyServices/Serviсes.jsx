...
const Serviсes = () => {
  return (
    <div className="serviсes dark__mode">
      <div className="serviсes__box container">
        <div
          className="serviсes__box__top"
          data-aos="fade-up"
        ...
        <div className="serviсes__box__flex">
          <div
            className="serviсes__box__flex__card"
            data-aos="fade-right"
            data-aos-offset="300"
