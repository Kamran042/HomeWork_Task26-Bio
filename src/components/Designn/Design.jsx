...
const Design = () => {
  ...
  const counterStyle1 = useSpring({
    number: isVisible ? 10 : 0,
    from: { number: 0 },
    config: { duration: 4000 },
  });

  const counterStyle2 = useSpring({
    number: isVisible ? 800 : 0,
    from: { number: 0 },
  ...
  return (
    <div className="design dark__mode">
      <div className="design__box container">
        <div className="design__box__left">
          <div
            className="design__box__left__top"
            data-aos="fade-up"
          ...
          <div
            className="design__box__left__cards"
            id="elementToAnimate"
            data-aos="fade-right"
            data-aos-offset="300"
            data-aos-easing="ease-in-sine"
          >
            <animated.div className="design__box__left__cards_card">
              <span class="icon">
                <svg
                  width="75"
                  height="60"
              ...
              <animated.h5>
                {counterStyle1.number.interpolate(
                  (val) => `${Math.floor(val)}+`
                )}
              </animated.h5>
            ...
            <animated.div className="design__box__left__cards_card">
              ...
              <animated.h5>
                {counterStyle2.number.interpolate(
                  (val) => `${Math.floor(val)}+`
                )}
              </animated.h5>
        ...
        <div className="design__box__right" data-aos="zoom-in-up">
          <h6>GET TOUCH ME?</h6>
          <p>
